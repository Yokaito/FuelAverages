  ...
  <form name="form" data-toggle="validator" role="form" method="POST" action="database/relatorio.php"> 
             ...
             <label for="nome">Selecione o carro (placa):</label>  
                    <div class="form-row">
                     ...
                     <select name="fcarro" class="form-control">
                        <?php
                      ...
                      <div class="form-group col-md-2">
                                <label for="data1">Data inicial</label>
                                  <input type="date" name="data1" class="form-control" id="inputAbastecimentoData" value= "<?php echo $data_ini;?>" aria-describedby="emailHelp">
                                </div></div>
                                <div class="form-row">
                      <div class="form-group col-md-2">
                                <label for="data2">Data final</label>
                                  <input type="date" name="data2" class="form-control" id="inputAbastecimentoData" value= "<?php echo $data_fim;?>" aria-describedby="emailHelp">
                                </div></div>
