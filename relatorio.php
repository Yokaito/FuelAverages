...
<!DOCTYPE html>
  ...
  <form name="form" data-toggle="validator" role="form" method="POST" action="database/relatorio.php"> 

              

              <div class="form-group"> 
                        <label for="sel1">Data</label>
                        <select name="fdata" class="form-control">
                        <?php
                      ...
                      ?>
                                  ...
                                  <option value="<?php echo $row['id_abastecimento']; ?>"><?php echo $row['id_abastecimento']; ?></option> 
                      <?php
                             }
                          }
                      ?>      
                      ...
                      <div class="form-group"> 
                        <label for="sel1">Exibir três melhores médias?</label>
                        <select class="form-control" name="melhorasMediasRelatorio" value= "<?php echo $melhormediaq;?>">
                          <option name="Não" value="Não">Não</option>
                 ...
                 <button type="submit"   name="salvarrelatorio" class="btn btn-primary">Gerar</button>
